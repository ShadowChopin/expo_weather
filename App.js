...
const CITY = ["Seoul", "Busan", "Suwon", "Tokyo", "Beijing", "Shanghai"];
const APIKEY = "174cdb2c225c67dc13190d7494372eff";
...
export default function App() {
  ...
  React.useEffect(() => {
    const timer = setTimeout(async () => {
      try {
        const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${region}&appid=${APIKEY}&units=metric`);
